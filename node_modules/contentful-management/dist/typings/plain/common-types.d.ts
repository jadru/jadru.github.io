...
export declare type PlainClientAPI = {
    ...
    comment: {
        ...
        create(params: OptionalDefaults<CreateCommentParams>, rawData: CreateCommentProps, headers?: Record<string, unknown>): Promise<CommentProps>;
        update(params: OptionalDefaults<UpdateCommentParams>, rawData: UpdateCommentProps, headers?: Record<string, unknown>): Promise<CommentProps>;
...
export declare type AlphaWorkflowExtension = {
    workflowDefinition: {
        get(params: OptionalDefaults<GetWorkflowDefinitionParams>, headers?: Record<string, unknown>): Promise<WorkflowDefinitionProps>;
        getMany(params: OptionalDefaults<GetSpaceEnvironmentParams & {
            query?: WorkflowDefinitionQueryOptions;
        }>, headers?: Record<string, unknown>): Promise<CollectionProp<WorkflowDefinitionProps>>;
        create(params: OptionalDefaults<CreateWorkflowDefinitionParams>, rawData: CreateWorkflowDefinitionProps, headers?: Record<string, unknown>): Promise<WorkflowDefinitionProps>;
        update(params: OptionalDefaults<UpdateWorkflowDefinitionParams>, rawData: UpdateWorkflowDefinitionProps, headers?: Record<string, unknown>): Promise<WorkflowDefinitionProps>;
        delete(params: OptionalDefaults<DeleteWorkflowDefinitionParams>, headers?: Record<string, unknown>): Promise<any>;
    };
    workflow: {
        getMany(params: OptionalDefaults<GetSpaceEnvironmentParams & {
            query?: WorkflowQueryOptions;
        }>, headers?: Record<string, unknown>): Promise<CollectionProp<WorkflowProps>>;
        create(params: OptionalDefaults<CreateWorkflowParams>, rawData: CreateWorkflowProps, headers?: Record<string, unknown>): Promise<WorkflowProps>;
        update(params: OptionalDefaults<UpdateWorkflowParams>, rawData: UpdateWorkflowProps, headers?: Record<string, unknown>): Promise<WorkflowProps>;
        delete(params: OptionalDefaults<DeleteWorkflowParams>, headers?: Record<string, unknown>): Promise<void>;
        complete(params: OptionalDefaults<CompleteWorkflowParams>, headers?: Record<string, unknown>): Promise<void>;
    };
};
